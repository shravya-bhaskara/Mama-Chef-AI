      ...
      <header className="bg-white border-b border-orange-100 py-6 px-4 mb-8">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-display font-bold text-gray-800 tracking-tight">Health-Focused Meal Planner</h1>
          </div>
        ...
        <Card className="border-orange-100 shadow-sm bg-white/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-gray-800 flex items-center gap-2">
              ...
              Create Your Health-Focused Meal Plan
            </CardTitle>
            <CardDescription>Get a personalized 7-day meal plan optimized for your nutritional goals, calorie targets, and health objectives</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Input {...field} placeholder="e.g., Vegetarian, Low-carb, Keto" className="border-orange-200" />
                      <FormMessage />
                    </FormItem>
                  )}
                />
          ...
          {mutation.data && (
            ...
            >
              <h2 className="text-2xl font-display font-bold text-gray-800 flex items-center gap-2">
                <ChefHat className="h-6 w-6 text-orange-500" />
                Your Health-Focused 7-Day Meal Plan
              </h2>
